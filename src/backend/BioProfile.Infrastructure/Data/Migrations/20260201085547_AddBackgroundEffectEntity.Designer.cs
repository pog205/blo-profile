...
namespace BioProfile.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260201085547_AddBackgroundEffectEntity")]
    partial class AddBackgroundEffectEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BioProfile.Domain.Entities.BioProfileEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Slug = "winter-theme",
                            TextColor = "#1e293b",
                            UserId = "winter-user-002",
                            Views = 0
                        });
                });

            modelBuilder.Entity("BioProfile.Domain.Entities.BioProfileSocialLink", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("BioProfileSocialLinks", (string)null);
                });
            ...
            modelBuilder.Entity("BioProfile.Domain.Entities.BioProfileSocialLink", b =>
                {
                    b.HasOne("BioProfile.Domain.Entities.BioProfileEntity", "BioProfile")
                        .WithMany("BioProfileSocialLinks")
            ...
            modelBuilder.Entity("BioProfile.Domain.Entities.BackgroundEffect", b =>
                {
                    b.Navigation("BioProfiles");
                });

            modelBuilder.Entity("BioProfile.Domain.Entities.BioProfileEntity", b =>
                {
                    b.Navigation("BioProfileSocialLinks");
